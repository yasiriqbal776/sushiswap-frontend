    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the YFBTC protocol have made
      ...
      return (
        <div>
          <p>Attention YFBTC Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with YFBTC is YFBTC/yCRV
            (Curve yPool tokens)
          </p>
